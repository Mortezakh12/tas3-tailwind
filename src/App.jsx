const App = () => {
  return (
    ...
    <>
      {/* header */}
      <h1 className="mx-32 mt-16 text-3xl font-bold sm:justify-center sm:flex text--primary-800 md:justify-start md:items-center">
        سبد دوره های شما
      </h1>
      <div className="mt-8 sm:gap-4 sm:w-full sm:justify-between sm:items-center sm:flex-col sm:flex lg:flex lg:flex-row md:flex-row md:space-x-4 md:justify-center md:space-y-0">
        {/* cart */}
        <div className="flex flex-col gap-4 ">
          <div className="">
            <div className="flex justify-between max-w-xs p-4 bg-white gap-x-4 rounded-xl">
              <img
                className="w-1/3"
                src="/src/assets/img/Rectangle 21.png"
              ></img>
                ...
                <div className="flex items-start justify-between gap-x-8">
                  ...
                  <span>
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-4 h-4 border-[0.75px] border-gray-400 rounded-full p-[1px]"
                      color="red"
                    >
                      <path
        ...
        {/* payment */}
        <div className="flex-col w-full max-w-xs py-4 bg-white rounded-xl ">
          ...
          <p className="mt-4 text-xs text-center text-text--secondary-700">
            کد تخفیف دارم!
          </p>
